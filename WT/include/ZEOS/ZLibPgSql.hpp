...
// (DO NOT EDIT: machine generated header) 'ZLibPgSql.pas' rev: 5.00
...
typedef void * __cdecl (*TPQfn)(void * Handle, int fnid, Windows::PInteger result_buf, Windows::PInteger 
...
#define DEFAULT_DLL_LOCATION "libpq.dll"
...
extern PACKAGE AnsiString DLL;
extern PACKAGE unsigned hDLL;
extern PACKAGE bool LibLoaded;
extern PACKAGE bool __fastcall PgSqlLoadLib(void);

}	/* namespace Zlibpgsql */
#if !defined(NO_IMPLICIT_NAMESPACE_USE)
using namespace Zlibpgsql;
#endif
#pragma option pop	// -w-
