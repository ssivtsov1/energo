...
{$ENDIF}
  ...
  NET = packed record
    //vio:           Pointer;
    netType:       NET_TYPE_TCPIP..NET_TYPE_NAMEDPIPE;
    {$IFNDEF LINUX}
    { TODO:
    May be that cannot compile under windows due to
    HANDLE type undefined.
    The original code in library mysql_com.h is:
    ...
    #ifdef WIN32
      HANDLE hPipe;
    #endif
...
function mysql_affected_rows(Handle: PMYSQL): cardinal;
begin
  Result := Handle.affected_rows.Data;
end;
