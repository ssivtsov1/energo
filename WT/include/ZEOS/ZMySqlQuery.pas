...
type
  ...
  published
    ...
    property AlternativeView: boolean read FAlternativeView write FAlternativeView default false;
  end;
...
begin
  ...
  begin
    ...
    Size := 0;
    Decimals := 0;
    FieldType := MySqlToDelphiTypeDesc(Query.Field(1), Size, Decimals, AlternativeView);
