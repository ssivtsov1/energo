...
public:
  ...
  static TMenuItem *ClientMenuItem;      // указатель на меню исходных документов
  ...
  static TMenuItem *CalcMenuItem;
  static TMenuItem *ToolsMenuItem;
