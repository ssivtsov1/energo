...
_fastcall TMainForm::TMainForm(TComponent *owner) : TWTMainForm(owner) {
 ...
 /* NormMenuItem->Add(CreateMenuItem("ТРЭ", true, DoNot));
  ...
  ServiseMenuItem->Add(CreateMenuItem("Оборудование ...", true));
    ServiseMenuItem->Items[2]->Add(CreateMenuItem("Счетчики ...", true));
      ServiseMenuItem->Items[2]->Items[0]->Add(CreateMenuItem("Счетчики", true, DoNot));
      ServiseMenuItem->Items[2]->Items[0]->Add(CreateSeparator());
      ServiseMenuItem->Items[2]->Items[0]->Add(CreateMenuItem("Виды счетчиков", true, DoNot));
      ServiseMenuItem->Items[2]->Items[0]->Add(CreateMenuItem("Классы точности", true, DoNot));
      ServiseMenuItem->Items[2]->Items[0]->Add(CreateMenuItem("Методы подключения", true, DoNot));
    ServiseMenuItem->Items[2]->Add(CreateMenuItem("Линии ...", true));
      ServiseMenuItem->Items[2]->Items[1]->Add(CreateMenuItem("Линии", true, DoNot));
      ...
      ServiseMenuItem->Items[2]->Items[1]->Add(CreateMenuItem("Кабеля силовые", true, DoNot));
      ServiseMenuItem->Items[2]->Items[1]->Add(CreateMenuItem("Провода", true, DoNot));
      ServiseMenuItem->Items[2]->Items[1]->Add(CreateMenuItem("Опоры", true, DoNot));
      ServiseMenuItem->Items[2]->Items[1]->Add(CreateMenuItem("Подвески", true, DoNot));
      ServiseMenuItem->Items[2]->Items[1]->Add(CreateMenuItem("Петли заземления", true, DoNot));
      ServiseMenuItem->Items[2]->Items[1]->Add(CreateSeparator());
      ServiseMenuItem->Items[2]->Items[1]->Add(CreateMenuItem("Материалы", true, DoNot));
    ServiseMenuItem->Items[2]->Add(CreateMenuItem("Трансформаторы ...", true));
      ServiseMenuItem->Items[2]->Items[2]->Add(CreateMenuItem("Трансформаторы силовые", true, DoNot));
    ...
    ServiseMenuItem->Items[2]->Add(CreateMenuItem("Компенсаторы", true, DoNot));
    ServiseMenuItem->Items[2]->Add(CreateMenuItem("Предохранители", true, DoNot));
    ServiseMenuItem->Items[2]->Add(CreateMenuItem("Коммутационное оборудование", true, DoNot));
    ServiseMenuItem->Items[2]->Add(CreateMenuItem("Трансформаторные подстанции", true, DoNot));
    ServiseMenuItem->Items[2]->Add(CreateMenuItem("Площадки", true, DoNot));
  ServiseMenuItem->Add(CreateMenuItem("Адрес ...", true));
    ...
    ServiseMenuItem->Items[3]->Add(CreateMenuItem("Улицы", true, AdiStreetBtn));
    ServiseMenuItem->Items[3]->Add(CreateMenuItem("Нас.Пункты1", true, AdkTownBtn1));
 ...
 ToolsMenuItem->Add(CreateMenuItem("Пользователи ...", true));
  ...
  ToolBar->AddButton("AdiAddress", "Адреса", AdmAddressMBtn);
