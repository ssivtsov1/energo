...
public:
  ...
  TWTParamItem* AddDb(AnsiString Label,TDataSet* DataSet,AnsiString FieldName,int EditLen,bool Break=true);
...
public:
  ...
  void SetRequired(TDBDataSet* DataSet,AnsiString FieldName);
};
