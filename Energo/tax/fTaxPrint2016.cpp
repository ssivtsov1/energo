...
int str_cnt;
//---------------------------------------------------------------------------
__fastcall TfRepTaxN2016::TfRepTaxN2016(TComponent* Owner)
...
void  TfRepTaxN2016::ShowTaxNal(int id_doc, int print)
{
  float val;
  int len;
...
//------------------------------------------------------------------------------
void __fastcall TfRepTaxN2016::crTwoPagesAddReports(TObject *Sender)
{
...
void __fastcall TfRepTaxN2016::PrintTaxBeforePrint(TCustomQuickRep *Sender,
      bool &PrintReport)
{
 if (counter == 0)
 {
...
void __fastcall TfRepTaxN2016::bLgotaBeforePrint(TQRCustomBand *Sender,
      bool &PrintBand)
{
...
void __fastcall TfRepTaxN2016::QRBand1BeforePrint(TQRCustomBand *Sender,
      bool &PrintBand)
{
...
void __fastcall TfRepTaxN2016::bSimpleBeforePrint(TQRCustomBand *Sender,
      bool &PrintBand)
{
...
void __fastcall TfRepTaxN2016::QRBand2AfterPrint(TQRCustomBand *Sender,
      bool BandPrinted)
{
 if (counter == 1)
  PrintTax->NewPage();
