...
//---------------------------------------------------------------------------
__fastcall TfRepTaxCor2014::TfRepTaxCor2014(TComponent* Owner)
...
void TfRepTaxCor2014::ShowTaxCor(int id_doc, int print)
{
  int len;
...
//---------------------------------------------------------------------------
void __fastcall TfRepTaxCor2014::QRBand3BeforePrint(TQRCustomBand *Sender,
      bool &PrintBand)
{
