...
int str_cnt;
//---------------------------------------------------------------------------
__fastcall TfRepTaxN2014_12::TfRepTaxN2014_12(TComponent* Owner)
...
void  TfRepTaxN2014_12::ShowTaxNal(int id_doc, int print)
{
  float val;
  int len;
...
//     if (ZQTax->FieldByName("reg_date")->AsDateTime >= TDateTime('01.04.2014'))
     ...
     if ( flag_taxpay ==0 )
     {
      if (ZQTax->FieldByName("abonname")->AsString.AnsiPos("неплатник") ==0  )
        lAbonName->Caption=ZQTax->FieldByName("abonname")->AsString+ " неплатник податку";
      else
...
//------------------------------------------------------------------------------
void __fastcall TfRepTaxN2014_12::crTwoPagesAddReports(TObject *Sender)
{
...
void __fastcall TfRepTaxN2014_12::PrintTaxBeforePrint(TCustomQuickRep *Sender,
      bool &PrintReport)
{
 if (counter == 0)
 {
...
void __fastcall TfRepTaxN2014_12::bLgotaBeforePrint(TQRCustomBand *Sender,
      bool &PrintBand)
{
...
void __fastcall TfRepTaxN2014_12::QRBand1BeforePrint(TQRCustomBand *Sender,
      bool &PrintBand)
{
...
void __fastcall TfRepTaxN2014_12::bSimpleBeforePrint(TQRCustomBand *Sender,
      bool &PrintBand)
{
...
void __fastcall TfRepTaxN2014_12::QRBand2AfterPrint(TQRCustomBand *Sender,
      bool BandPrinted)
{
 if (counter == 1)
  PrintTax->NewPage();
