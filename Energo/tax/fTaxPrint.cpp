...
int str_cnt;
//---------------------------------------------------------------------------
__fastcall TfRepTaxN::TfRepTaxN(TComponent* Owner)
...
void  TfRepTaxN::ShowTaxNal(int id_doc, int print)
{
  float val;
  int len;
...
//     lTaxDate->Caption=ZQTax->FieldByName("reg_date")->AsString;
     ...
     lFormPay->Caption="Оплата з поточного рахунка";
...
//------------------------------------------------------------------------------
void __fastcall TfRepTaxN::crTwoPagesAddReports(TObject *Sender)
{
...
void __fastcall TfRepTaxN::PrintTaxBeforePrint(TCustomQuickRep *Sender,
      bool &PrintReport)
{
 if (counter == 0)
 {
...
void __fastcall TfRepTaxN::bLgotaBeforePrint(TQRCustomBand *Sender,
      bool &PrintBand)
{
...
void __fastcall TfRepTaxN::QRBand1BeforePrint(TQRCustomBand *Sender,
      bool &PrintBand)
{
...
void __fastcall TfRepTaxN::bSimpleBeforePrint(TQRCustomBand *Sender,
      bool &PrintBand)
{
...
void __fastcall TfRepTaxN::QRBand2AfterPrint(TQRCustomBand *Sender,
      bool BandPrinted)
{
 if (counter == 1)
  PrintTax->NewPage();
