...
int str_cnt;
//---------------------------------------------------------------------------
__fastcall TfRepTaxN2015::TfRepTaxN2015(TComponent* Owner)
...
void  TfRepTaxN2015::ShowTaxNal(int id_doc, int print)
{
  float val;
  int len;
...
//------------------------------------------------------------------------------
void __fastcall TfRepTaxN2015::crTwoPagesAddReports(TObject *Sender)
{
...
void __fastcall TfRepTaxN2015::PrintTaxBeforePrint(TCustomQuickRep *Sender,
      bool &PrintReport)
{
 if (counter == 0)
 {
...
void __fastcall TfRepTaxN2015::bLgotaBeforePrint(TQRCustomBand *Sender,
      bool &PrintBand)
{
...
void __fastcall TfRepTaxN2015::QRBand1BeforePrint(TQRCustomBand *Sender,
      bool &PrintBand)
{
...
void __fastcall TfRepTaxN2015::bSimpleBeforePrint(TQRCustomBand *Sender,
      bool &PrintBand)
{
...
void __fastcall TfRepTaxN2015::QRBand2AfterPrint(TQRCustomBand *Sender,
      bool BandPrinted)
{
 if (counter == 1)
  PrintTax->NewPage();
