...
void __fastcall TfFiderDet::sbWorksClick(TObject *Sender)
{
  ...
  fMonitorFiderWorks->ShowAs("Журнал тех. работ фидера");

  fMonitorFiderWorks->ID="Журнал тех. работ фидера";
...
void __fastcall TfFiderDet::sbPlanWorksClick(TObject *Sender)
{
  ...
  fWorkPlan->ShowAs("План работ фидера");

  fWorkPlan->ID="План работ фидера";
...
//  Field = WFiderGrid->AddColumn("kindname", "Тип", "Тип");
  ...
  Field = WPSGrid->AddColumn("voltage_min", "Напряжение", "Напряжение");
