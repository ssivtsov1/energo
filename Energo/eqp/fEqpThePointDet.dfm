    ...
    object TabSheet1: TTabSheet
      ...
      object pMeterMain: TPanel
        ...
        object Label2: TLabel
          ...
          Width = 141
          Height = 13
          Caption = 'Виды учитываемой энергии'
        end
        ...
        object Label7: TLabel
          ...
          Width = 221
          Height = 13
          Caption = 'Эконом. эквивалент реактивной мощности'
        end
        ...
        object Label3: TLabel
          ...
          Width = 219
          Height = 13
          Caption = 'Уровень напряжения (на границе раздела)'
        end
        ...
        object Label18: TLabel
          ...
          Width = 154
          Height = 13
          Caption = 'Присоед. мощьность кВт/кВА'
        end
        ...
        object cbMainLosts: TCheckBox
          ...
          Width = 173
          Height = 17
          Caption = 'Не делить потери основного '
          TabOrder = 8
          OnClick = cbCounLostClick
        end
        ...
        object cbReserv: TCheckBox
          ...
          Width = 225
          Height = 17
          Caption = 'резервный учет (1 класс потребления)'
          TabOrder = 10
          OnClick = cbCounLostClick
        end
        object cbInLost: TCheckBox
          ...
          Width = 281
          Height = 17
          Caption = 'Точка продажи на границе основного'
          TabOrder = 11
          OnClick = cbCounLostClick
        end
        ...
        object cbKVA: TCheckBox
          ...
          Width = 25
          Height = 17
          Hint = 'Приєднана потужність в кВА'
          ParentShowHint = False
          ShowHint = True
          TabOrder = 14
        end
    ...
    object TabSheet2: TTabSheet
      ...
      object Panel1: TPanel
        ...
        object Label8: TLabel
          ...
          Width = 223
          Height = 13
          Caption = 'Процент от потребления на основном учете'
        end
        object Label10: TLabel
          ...
          Width = 200
          Height = 13
          Caption = 'Мощность компенсирующих установок'
        end
        object Label11: TLabel
          ...
          Height = 13
          Caption = 
            'Учесть в расчете загрузку измерительных трансформаторов ниже 5% ' +
            'номинала'
        end
        object Label12: TLabel
          ...
          Width = 307
          Height = 13
          Caption = 'Потребление за пред. период (акт/реакт/генер) / кол. дней '
        end
        ...
        object Label15: TLabel
          ...
          Height = 13
          Anchors = [akTop, akRight]
          Caption = 'Напряжение на ТУ (дейст.)  '
        end
        ...
        object cbHlosts: TCheckBox
          ...
          Width = 181
          Height = 17
          Caption = 'Разрешить ручной ввод потерь'
          TabOrder = 8
          OnClick = cbCounLostClick
        end
