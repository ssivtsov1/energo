...
//  TMemIniFile *IniStart=new TMemIniFile("startup.ini");
  ...
  AnsiString Alias=StartupIniFile->ReadString("Base","Alias","energo_clear");
  AnsiString Host=StartupIniFile->ReadString("Base","Host","127.0.0.1");
  AnsiString Port=StartupIniFile->ReadString("Base","Port","5432");
  AnsiString Login=StartupIniFile->ReadString("Base","Login","postgres");
  AnsiString Encoding=StartupIniFile->ReadString("Base","Encoding","win");
