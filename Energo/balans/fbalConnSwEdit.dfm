object fbalConnSwitchEdit: TfbalConnSwitchEdit
  ...
  object Panel2: TPanel
    ...
    object Label3: TLabel
      ...
      Width = 140
      Height = 13
      Caption = 'Дата начала переключения'
    end
    object Label1: TLabel
      ...
      Width = 135
      Height = 13
      Caption = 'Дата конца переключения'
    end
