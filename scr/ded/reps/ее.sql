...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (702, 'abonnofider', 700 , 'Непiдключенi абоненти.', 'Абоненти, не пiдключенi до мережi РЕМ. ', 'abonnofider.xls', NULL,64);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (703, 'abonps', 700 , 'По пiдстанцiям.', 'Абоненти,  пiдключенi до пiдтанцi╖ (Потужнiсть). ', 'abonps.xls', NULL, 288);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (704, 'fizabonfiderdem', 700 , 'Спожив. населення по ПС', 'Споживання населення за мiсцем пiдключення. ', 'fizabonfiderdem.xls', NULL,34);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (705, 'border', 700 , 'Границя з РЕМ', 'Перелiк абонентiв, що пiдключенi безпосередньо до мереж РЕМ.', 'border.xls', NULL,0);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (706, 'abonconnect', 700 , 'Перевiрка фiз. осiб', 'Перелiк абонентiв з мiсцем пiдключення ', 'abonconnect.xls', NULL,0);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (707, 'pointnometer', 700,'Без приладiв облiку', 'Перелiк точек облiку не обладнаних приладами облiку ', 'pointnometer.xls', NULL,0);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (708, 'rep_con_abon', 700,'Новi пiдключення', 'Звiт по новим пiдключеним абонентам', 'newconnect.xls', NULL,2);
...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1009, 'points_ta2_all', 1000, 'Точки облiку (всi)', 'Загальна iнформацiя по точкам облiку споживачiв (всi рiвнi напруги) ', 'points_6kv.xls', NULL,2);
