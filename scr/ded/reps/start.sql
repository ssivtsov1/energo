...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (103, 'oborot_nds', 100, 'Оборотна вiдомiсть з ПДВ', 'Оборотна вiдомiсть розрахунку за електроенергiю (розгорнуто по ПДВ)', 'oborot_nds.xls', NULL,10);
...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (105, 'oborot_5kr', 100, 'Оборотна вiдомiсть 5/2кр', 'Оборотна вiдомiсть розрахунку по застосуванню пiдвищено╖ плати за перевищення договiрних обсягiв споживання електроенергi╖ ', 'oborot_5kr.xls', NULL,10);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (106, 'oborot_1', 100, 'Оборотна вiдомiсть абон.', 'Оборотна вiдомiсть по абоненту. ', 'oborot_1.xls', NULL,11);
...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (117, 'f24', 100, 'Форма 24 енерго', 'Форма 24 енерго. Споживання електроенергi╓ по мiнiстерствах.', 'f24.xls', NULL,10);
...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (120, 'NDS2011_inf', 100, 'Звiт по ПДВ(деталiзацiя)', 'Звiт по ПДВ (деталiзацiя оплати та погашення до 1 квiтня 2011 року).', 'nds2011_billpay.xls', NULL,10);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (121, 'abon_volt', 100, 'Споживання по напрузi', 'Споживання електроенергi╓ по рiвням напруги.', 'abonvolt.xls', NULL,10);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (122, 'abon_dep', 100, 'Споживання по мiнiст.', 'Споживання електроенергi╓ по мiнiстерствах .', 'abondep.xls', NULL,10);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (123, 'abon_grp', 100, 'Споживання по групам.', 'Споживання електроенергi╓ по групах споживачiв .', 'abongrp.xls', NULL,10);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (124, 'prognoz', 100, 'Прогноз.', 'Аналiз обсягiв корисного вiдпуску.', 'prognoz.xls', NULL,130);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (125, 'oborot_year', 100, 'Споживання за рiк', 'Оборотна вiдомiсть (споживання за рiк)', 'oborot_year.xls', Null,10);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (126, 'point_dem_year', 100, 'Споживання за рiк по ТУ.', 'Споживання за рiк по точкам облiку', 'point_dem_year.xls', Null,2);
...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (203, 'ind_dates', 200, 'Дати надання звiтiв ', 'Перелiк абонентiв по датам надання звiтiв про споживання ', 'ind_dates.xls', NULL,1024+2);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (204, 'ind_debtor', 200, 'Не надали вчасно звiти ', 'Перелiк абонентiв, що вчасно не надали звiт про споживання', 'IndicDebtor.xls', NULL,1024+6);
...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (206, 'bill_list', 200, 'Рахунки за перiод', 'Рахунки за перiод', 'billist.xls', NULL,1024+10);
...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (214, 'pointlist', 200, 'Т.облiку абонента', 'Характеристики точок облiку електрично╓ енергi╓ абонента.', 'pointlist.xls', NULL,5);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (215, 'switch', 200, 'Вiдключення', 'Стан абонентiв (вiдключення).', 'switchlist.xls', NULL,1024+0);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (216, 'prognozpay', 200, 'Подекаднi виплати', 'Розрахунок сум подекадних виплат.', 'prognozpay.xls', NULL,1024+2);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (217, 'progpayadd', 200, 'Подекадний прогноз', 'Розрахунок сум подекадних виплат з врахуванням оплат.', 'progpayadd.xls', NULL,1024+2);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (218, 'progpayad5', 200, 'Прогноз по 5 дневкам', 'Розрахунок сум виплат з врахуванням оплат по 5-ти денкам', 'progpayadd5.xls', NULL,1024+2);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (219, 'progpaydem', 200, 'Прогноз c тарифом', 'Розрахунок сум виплат з врахуванням оплат по 5-ти денкам', 'progpaydem5.xls', NULL,1024+2);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (220, 'empty_ind', 200, 'Порожнi звiти', 'Порожнi звiти про споживання та авансовi рахунки.', 'empty_ind.xls', NULL,2);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (221, 'avg_area_dem', 200, 'Середн╓.спожив. по майд.', 'Середньомiсячне споживання по майданчикам за 6 мiс.', 'avg_area_dem.xls', NULL,1024+2);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (222, 'avg_area_dem12', 200, 'Сер.спож.по майд.12 мiс', 'Середньомiсячне споживання по майданчикам за 12 мiс.', 'avg_area_dem12.xls', NULL,1024+2);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (223, 'compens_cnt', 200,  'Завантаження.трасф.< 5%', 'Завантаження  трасформаторiв на облiках.', 'compens_cnt.xls', NULL,2);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (224, 'abonfider_compens', 200,  'Завант.трасф.<5%(2 мiс)', 'Облiк недовраховано╓ електроенергi╓ при споживаннi менше 5% завантаженостi облiкового трансформатора (поточний та попереднiй перiоди).', 'abonfider_compens.xls', NULL,2+32);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (225, 'doc_revis', 200,  'Переукладання договорiв', 'Звiт по переукладанню договорiв', 'doc_revis.xls', NULL,1024+2);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (226, 'check2kr', 200,  'Перевiрка рахункiв по 2кр', 'Перевiрка наявностi рахункiв за перевищення лiмiту споживання', 'check2kr.xls', NULL,2);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (227, 'check2krNoLimit', 200,  'Споживання без лiмiтiв', 'Споживання абонентiв, для яких не вказано лiмiт споживання', 'check2kr_nolimit.xls', NULL,2);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (228, 'abonpower', 200, 'Потужнiсть абонентiв', 'Перелiк абонентiв (дозволена потужнiсть)', 'clientlist_power.xls', NULL,4);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (229, 'unif_fiz', 200, 'Единий податок', 'Перелiк доходiв у розрiзi контрагентiв - платникiв ╜диного податку', 'unif_fiz_sum.xls', NULL,2);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (230, 'point_procent', 200, 'Змiна споживання по ТУ %.', 'Змiна споживання по точкам облiку', 'point_dem_procent.xls', Null,2);
...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (304, 'abon_tar', 300, 'Споживання по тарифах', 'Споживання електроенергi╓ по тарифах.', 'abontarif.xls', NULL,10);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (305, 'all_tar', 300, 'Точки облiку по тарифах', 'Перелiк точок облiку та споживання електроенергi╓ по тарифах.', 'abonalltarif.xls', NULL,518);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (306, 'abontar_2month', 300, 'Порiвняння спож. по тар.', 'Порiвняння споживання електроенергi╓ по тарифах.', 'abon_tar_2month.xls', NULL,2);
...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (308, '9nkre_d2', 300, '9 НКРЕ дод.2', 'Додаток 2 до 9 НКРЕ. Релiгiйнi органiзацi╖.', '9nkre_d2.xls', NULL,2);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (309, '9nkre_d3', 300, '9 НКРЕ дод.3', 'Додаток 1 до 9 НКРЕ. Заклади пенiтенцiарно╖ системи.', '9nkre_d3.xls', NULL,2);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (310, 'nasp_demand', 300, 'По насел. та нас. пунктах', 'Споживання за тарифами населення та нас.пунктiв', 'nasp_demand.xls',NULL,2);
...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (402, 'met_3zon', 400, 'Дифтарифи', 'Розрахунок суми компенсацi╖ втрат вiд здiйснення постачання ел. енергi╖ за диф. тарифами ', 'met_3zon.xls', NULL,2);
...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (404, 'lighting', 400, 'Освiтлення', 'Розрахунок суми компенсацi╖ втрат вiд здiйснення постачання ел. енергi╖,яка використову╓ться для зовн╕шнього осв╕тлення.', 'lighting.xls', NULL,2);
...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (415, 'abon_volt_lst', 400, 'Споживання по втр/безвтр.', 'Споживання електроенергi╓ по структурi корисного вiдпуску.', 'abonvoltlst.xls', NULL,10);
...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (509, 'tax_list_abon', 500 , 'ПН абонента', 'Журнал податкових накладних абонента за перiод', 'taxlist_abon.xls', NULL,1+2);
...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (706, 'abonps', 700 , 'По пiдстанцiям.', 'Абоненти,  пiдключенi до пiдтанцi╖ (Потужнiсть). ', 'abonps.xls', NULL, 288);
...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (715, 'homenets_demand', 700 , 'Внутрiшньобуд. мережi', 'Баланс надходження та споживання електроенергi╓ у внутришньобудинкових мережах .', 'homenets.xls', NULL,2);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (716, 'prognoz_fider', 700 , 'План-завдання', 'План-завдвння (перед формуванням плановi показники занести в таблицю "Расчеты" -"Плановые показатели" )', 'prognoz_fider.xls', NULL,2+32+1024);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (717, 'fact_fider', 700 , 'Виконання плану', 'Фактичне виконання плану-завдвння (перед формуванням плановi показники занести в таблицю "Расчеты" -"Плановые показатели" )', 'prognoz+fact_fider.xls', NULL,2+32+1024);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (718, 'fidersdemand', 700 , 'Споживання по ТУ', 'Споживання абонента по точкам облiку за мiсцем пiдключення', 'abonfider_dem.xls', NULL,1+2+32);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (719, 'ps10_load', 700 , 'Завантаження ПТ10/0.4', 'Iнформацiя щодо завантаження та резерву потужностi трансформаторних пiдстанцiй 10/0.4 кВ', 'ps10_load.xls', NULL,2);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (720, 'ps35_load', 700 , 'Завантаження ПТ110-35/10', 'Iнформацiя щодо завантаження та резерву потужностi трансформаторних пiдстанцiй 110-35/10 кВ', 'ps35_load.xls', NULL,2);
...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (801, 'r_f32', 800, '4 НКРЕ РЕ', 'Перетоки реактивно╓ електроенергi╓ по тарифним групам ', 'r_f32.xls', NULL,2);
...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (803, 'r_compens', 800, 'Компенсацiя втрат.', 'Звiт по компенсацi╓ втрат вiд перетокiв реактивно╓ електроенергi╓ ', 'r_compens.xls', NULL,2);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (804, 'reactiv_2010', 800, 'Розрахунок по ТУ.', 'Iнформацiя щодо розрахункiв плати за перетiкання реактивно╓ електроенергi╓', 'reactiv2010.xls', NULL,2);
...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (905, 'worm_meters', 900, 'Спожив. згiдно п7.15 ППЕЕ', 'Споживання по лiчильникам, встановленим у неопалюваному примiщеннi.', 'worm_meter.xls', NULL,10);
...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (911, 'meter_indic_hist', 900, 'Iсторiя лiчильникiв', 'Iсторiя зняття показникiв та iнших подiй лiчильникiв за перiод', 'meter_indic_hist.xls', NULL,2+1);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (912, 'bad_indic_list', 900, 'Контроль показань', 'Перелiк лiчильникiв, на яких знайденi неспiвпадiння поточних показань з контрольними', 'bad_indication.xls', NULL,2);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (913, 'dub_meterlist', 900, 'Пошук дублiв', 'Пошук дублiв номерiв лiчильникiв.', 'meterdubl.xls', NULL,0);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (914, 'metnodemand3', 900, 'Без споживання >2 мiс.', 'Лiчильники, що не мають показникiв або мають нульове споживання бiльше 2 мiсяцiв.', 'metnodemand3.xls', NULL,2);
...
--INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1003, 'rentdates', 1000, 'Термiн оренди', 'Перелiк абонентiв, у яких закiнчу╓ться термiн оренди. ', 'rentdates.xls', NULL,2);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1004, 'rentdates_all', 1000, 'Термiн оренди (перелiк)', 'Дати закiнчення термiну договорiв оренди', 'rentdates_all.xls', NULL,0);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1005, 'point_err', 1000, 'Помилки в iсторi╖ ', 'Точки облiку, iнформацiя по яким не буде вибрана до звiтiв через некоректнi данi в iсторi╖. ', 'point_err.xls', NULL,2);
...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1007, 'kur_meter', 1000, 'Лiчильники по кур╜рам', 'Лiчильники по кур╜рам ', 'kur_meter.xls', NULL,1024+4);
...
--INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1008, 'points_ta2', 1000, 'Точки облiку (Т.А.2)', 'Таблиця А.2. Загальна iнформацiя по точкам облiку споживачiв, при╜днаних до рiвня напруги >=6 кВ ', 'points_6kv.xls', NULL,2);
...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1014, 'warning_debet_list', 1000, 'Перелiк попередж.(дебет)', 'Перелiк для попереджень про припинення електропостачання дебiторам', 'warning_list1.xls', NULL,2+4+1024);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1015, 'warning_avans_list', 1000, 'Перелiк попередж.(аванс)', 'Перелiк для попереджень про припинення електропостачання дебiторам (аванс)', 'warning_list2.xls', NULL,2+4+1024+4096);
...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1017, 'point_change', 1000, 'Змiни потужностi', 'Змiни потужностi на точках облiку за перiод', 'point_change.xls', NULL,2);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1018, 'renthist', 1000, 'Тимчасовi договори', 'Тимчасовi договори про постачання електроенергii, термiн яких закiнчу╓ться', 'renthist.xls', NULL,2);
...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1020, 'abon_area_dem', 1000, 'Майданчики абонентiв', 'Обсяги постачання електрично╓ енергi╓ споживачу по майданчикам', 'abon_area_dem.xls', NULL,2+1);
...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1103, 'limit2kr_calc', 1100, 'Розрах. макс. лiмiта', 'Розрахунок максимально можливого лiмiту споживання, виходячи з наявностi передоплати. ', 'limit_calc.xls', NULL,2+4);
...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1202, 'monitor_a2', 1200, 'Табл.А.2 (загальна)', 'Таблиця А.2. Загальна iнформацiя щодо споживачiв, при╜днаних на ступенi напруги 0.4 кВ ', 'monitor_a2.xls', NULL,2);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1203, 'monitor_a3', 1200, 'Табл.А.3 (загальна)', 'Таблиця А.3. Загальна iнформацiя щодо споживачiв, при╜днаних на ступенях напруги 6-154 кВ ', 'monitor_a3.xls', NULL,2);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1204, 'monitor_a6', 1200, 'Точки облiку (Т.А.6)', 'Таблиця А.6. Загальна iнформацiя по точкам облiку споживачiв, при╜днаних до рiвня напруги >=6 кВ ', 'points_6kv.xls', NULL,2);
...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1206, 'monitor_a2m', 1200, 'Табл.А.2 (Чер.МЕМ)', 'Таблиця А.2. Загальна iнформацiя щодо споживачiв, при╜днаних на ступенi напруги 0.4 кВ (Тiльки для Чернiгiвських МЕМ)', 'monitor_a2.xls', NULL,2);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1207, 'monitor_a3m', 1200, 'Табл.А.3 (Чер.МЕМ)', 'Таблиця А.3. Загальна iнформацiя щодо споживачiв, при╜днаних на ступенях напруги 6-154 кВ (Тiльки для Чернiгiвських МЕМ)', 'monitor_a3.xls', NULL,2);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1208, 'monitor_a6m', 1200, 'Табл.А.6 (Чер.МЕМ)', 'Таблиця А.6. Загальна iнформацiя по точкам облiку споживачiв, при╜днаних до рiвня напруги >=6 кВ (Тiльки для Чернiгiвських МЕМ) ', 'points_6kv.xls', NULL,2);
...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1210, 'ms_voltage', 1200, 'Основнi/суб по напрузi', 'Загальна iнформацiя по споживачам, при╜днаним на рiзних рiвнях напруги', 'ms_voltage.xls', NULL,2);
...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1304, 'monitor_a2_2010', 1300, 'Табл.А.2 (2010)', 'Таблиця А.2. Загальна iнформацiя щодо споживачiв, при╜днаних на ступенi напруги 0.4 кВ ', 'monitor_a2_2010.xls', NULL,2);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1305, 'monitor_a3_2010', 1300, 'Табл.А.3 (2010)', 'Таблиця А.3. Загальна iнформацiя щодо споживачiв, при╜днаних на ступенях напруги 6-154 кВ ', 'monitor_a3_2010.xls', NULL,2);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1306, 'monitor_10k', 1300, 'Точки облiку межа >1к', 'Загальна iнформацiя по точкам облiку споживачiв, межа розпод?лу  рiвня напруги >=6 кВ ', 'points_6kv.xls', NULL,2);
...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1405, 'worktech', 1400, 'Термiн тех.перевiрки', 'Перелiк точок облiку, в яких термiн дi╓ технiчно╓ перевiрки закiнчу╜ться до : ', 'worktech.xls', NULL,4);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1406, 'workcontr', 1400, 'Термiн контр.огляду', 'Перелiк точок облiку, в яких термiн дi╓ контрольного огляду закiнчу╜ться до : ', 'worktech.xls', NULL,4);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1407, 'workreq', 1400, 'Термiн виконання вимог', 'Перелiк точок облiку, в яких термiн виконання вимог сплива╜ на вказану дату', 'workreq.xls', NULL,4);
...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1702, 'masters_akt', 1700 , 'Акт (кошторис)', 'Акт прийому - здачi по кошторису', 'masterdemandakt.xls', NULL,2+1);
