...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (118, 'NDS', 100, 'Звiт по ПДВ', 'Звiт по ПДВ.', 'nds.xls', NULL,10);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (119, 'abon_volt', 100, 'Споживання по напрузi', 'Споживання електроенергi╓ по рiвням напруги.', 'abonvolt.xls', NULL,10);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (120, 'abon_dep', 100, 'Споживання по мiнiст.', 'Споживання електроенергi╓ по мiнiстерствах .', 'abondep.xls', NULL,10);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (121, 'abon_grp', 100, 'Споживання по групам.', 'Споживання електроенергi╓ по групах споживачiв .', 'abongrp.xls', NULL,10);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (122, 'prognoz', 100, 'Прогноз.', 'Аналiз обсягiв корисного вiдпуску.', 'prognoz.xls', NULL,130);
...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (221, 'avg_area_dem', 200, 'Середн╓.спожив. по майд.', 'Середньомiсячне споживання по майданчикам за рiк.', 'avg_area_dem.xls', NULL,1024+2);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (222, 'compens_cnt', 200,  'Завантаження.трасф.< 5%', 'Завантаження  трасформаторiв на облiках.', 'compens_cnt.xls', NULL,1024+2);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (223, 'doc_revis', 200,  'Переукладання договорiв', 'Звiт по переукладанню договорiв', 'doc_revis.xls', NULL,1024+2);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (224, 'check2kr', 200,  'Перевiрка рахункiв по 2кр', 'Перевiрка наявностi рахункiв за перевищення лiмiту споживання', 'check2kr.xls', NULL,2);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (225, 'check2krNoLimit', 200,  'Споживання без лiмiтiв', 'Споживання абонентiв, для яких не вказано лiмiт споживання', 'check2kr_nolimit.xls', NULL,2);
...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (505, 'freetaxnum', 500 , 'Пропущенi номери', 'Перелiк  пропущених номерiв податкових накладних ', 'freetaxnum.xls', NULL,2);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (506, 'taxcheck', 500 , 'Перевiрка', 'Перевiрка податкових накладних ', 'taxchecklist.xls', NULL,10);
...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (602, 'akt2', 600 , 'Акт звiрки (бюдж.).', 'Акт звiрки розрахункiв для бюджетних споживачiв ', 'akt2.xls', NULL,13);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (603, 'akt3', 600 , 'Акт звiрки (3 зон.).', 'Акт звiрки розрахункiв (по диф. тарифам) ', 'akt3.xls', NULL,3);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (604, 'akt_2z', 600 , 'Акт звiрки (2 зон.).', 'Акт звiрки розрахункiв (по 2 зонним диф. тарифам) ', 'akt_2z.xls', NULL,3);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (605, 'akt4', 600 , 'Акт по перiодах.', 'Акт звiрки розрахункiв (по перiодах) ', 'akt4.xls', NULL,15);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (606, 'akt5', 600 , 'Акт звiрки (докладний)', 'Акт звiрки розрахункiв (докладна iнформацiя по рахункам та оплатi) ', 'akt5.xls', NULL,11);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (607, 'akt_tr', 600 , 'Акт звiрки (ел.трансп.)', 'Акт звiрки розрахункiв (по мiському електротранспорту) ', 'akt_trans.xls', NULL,3);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (608, 'akt_him', 600 , 'Акт звiрки (хiм. пром.)', 'Акт звiрки розрахункiв (по хiмiчнiй промисловостi) ', 'akt_him.xls', NULL,3);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (609, 'akt_osv', 600 , 'Акт звiрки (вул.осв.)', 'Акт звiрки розрахункiв (Вуличне освiтлення) ', 'akt_osv.xls', NULL,3);
...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (902, 'metercheck', 900, 'Потрiбна повiрка', 'Перелiк лiчильникiв, яким потрiбна повiрка у вказаному перiодi.', 'meterchecklist.xls', NULL,2);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (903, 'worm_meters', 900, 'Спожив. згiдно п7.15 ППЕЕ', 'Споживання по лiчильникам, встановленим у неопалюваному примiщеннi.', 'worm_meter.xls', NULL,10);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (904, 'print_tt', 900, 'Вимiрювальнi тр.', 'Споживання по вимiрювальним трансформаторам.', 'tt_demand.xls', NULL,2);
...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1004, 'point_err', 1000, 'Помилки в iсторi╖ ', 'Точки облiку, iнформацiя по яким не буде вибрана до звiтiв через некоректнi данi в iсторi╖. ', 'point_err.xls', NULL,2);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1005, 'gor_kur', 1000, 'План перевiрок', 'План перевiрок облiкiв. ', 'grafik.xls', NULL,1024+4);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1006, 'kur_meter', 1000, 'Лiчильники по кур╜рам', 'Лiчильники по кур╜рам ', 'kur_meter.xls', NULL,1024+4);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1007, 'tables', 1000, 'Структура бази', 'Структура бази. ', 'tablelist.xls', NULL,0);
...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1200, '_gr', NULL, 'Монiторинг', 'Монiторинг', NULL, NULL,0);
...
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1300, '_gr', NULL, 'Роботи', 'Роботи', NULL, NULL,0);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1301, 'plomblistall', 1300, 'Перелiк пломб на дату', 'Перелiк пломб, що встановленi станом на вказану дату:', 'plomb_list_now.xls', NULL,1+4+1024);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1302, 'plombinstall', 1300, 'Встановленi пломби', 'Перелiк пломб, що встановленi за перiод ', 'plomb_list_all.xls', NULL,1+2+1024);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1303, 'plombdelete', 1300, 'Снятi пломби', 'Перелiк пломб, що снятi за перiод ', 'plomb_list_all.xls', NULL,1+2+1024);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1304, 'worklist', 1300, 'Роботи за перiод', 'Перелiк робiт, що виконанi за перiод ', 'work_list_all.xls', NULL,1+2+1024);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1305, 'worktech', 1300, 'Термiн тех.перевiрки', 'Перелiк точок облiку, в яких термiн дi╓ технiчно╓ перевiрки закiнчу╜ться до : ', 'worktech.xls', NULL,4);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1306, 'workcontr', 1300, 'Термiн контр.огляду', 'Перелiк точок облiку, в яких термiн дi╓ контрольного огляду закiнчу╜ться до : ', 'worktech.xls', NULL,4);
INSERT INTO rep_kinds_tbl (id, ident, id_group, name, full_name, file_name, proc_name,flag_param) VALUES (1307, 'workreq', 1300, 'Термiн виконання вимог', 'Перелiк точок облiку, в яких термiн виконання вимог сплива╜ на вказану дату', 'workreq.xls', NULL,4);
